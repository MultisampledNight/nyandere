...
//! # Comparison with [`db`]
//!
//! While [`db`] is generated by the script `util/regen`
//! directly from the database,
//! _this_ module is a wrapper over it, providing:
//!
//! - More type safety
//! - Less possibilities for accidental errors
//!
//! You will probably never need to directly use [`db`],
//! unless you want to
